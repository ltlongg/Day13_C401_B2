...
### Lê Thành Long
- [TASKS_COMPLETED]: Cấu hình chỉ số SLO (Latency < 2s, Error < 1%) trong `slo.yaml`, thiết lập quy tắc cảnh báo trong `alert_rules.yaml` cho các trường hợp hệ thống chậm hoặc vượt ngân sách.
...
- [EVIDENCE_LINK]: https://github.com/ltlongg/Day13_C401_B2/tree/sprint-5
